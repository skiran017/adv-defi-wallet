    ...
    <div className="container">
        ...
        <div className="col-sm-12">
          ...
          <div className="jumbotron">
            <h1 className="display-4 text-center">
              Automatically save your ETH / DAI <br />
              to Compound
            </h1>
          </div>
        </div>
        ...
        <div className="col-sm-12">
          ...
          <form>
            <div className="form-group row">
              <label htmlFor="balance-eth" className="col-sm-2 col-form-label">
                Balance
              </label>
      ...
      <div className="row">
        <div className="col-sm-12">
          ...
          <form>
            <div className="form-group row">
              <label htmlFor="balance-dai" className="col-sm-2 col-form-label">
                Balance
              </label>
              <div className="col-sm-10">
                <input
